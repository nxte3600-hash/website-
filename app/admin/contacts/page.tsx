...
export default async function AdminContactsPage() {
  ...
  return (
    <AdminShell>
      ...
      <div className="mt-8">
        <AdminLeadTable leads={leads.length ? leads : [{ name: "Sample contact", phone: "+91 XXXXX XXXXX", city: "Noida", status: "New", collection: "contactLeads", message: "Asked for fleet purchase callback." }]} />
      </div>
    </AdminShell>
  );
}
